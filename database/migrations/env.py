...
if not config.get_main_option("sqlalchemy.url"):
    # Loads the environment variables from .env at the root folder
    load_dotenv(dotenv_path=Path.joinpath(Path(__file__).parent.parent.parent, ".env.development"))
    # Sets the sqlalchemy url using environment variables
